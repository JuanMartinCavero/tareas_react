      ...
      {blogs.slice(0,4).map((blog)=>(
        <div key={blog.title} className='relative'>
          ...
          {/*INFO */}
            ...
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Commodi nisi consequatur quas harum fugit laboriosam officia, at eaque unde excepturi, assumenda sapiente praesentium in, voluptatibus odit sit. Accusantium, voluptatum error.</p>
